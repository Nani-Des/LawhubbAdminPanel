...
const PrintScheduleModal: React.FC<PrintScheduleModalProps> = ({
  ...
  const generatePrintContent = () => {
    ...
    if (printType === 'selected' && selectedDoctors.length === 1) {
      ...
      title = `Schedule for Selected Lawyers`;
    } else if (printType === 'department' && selectedDepartment) {
      const dept = departments.find(d => d.id === selectedDepartment);
      title = `Schedule for ${dept?.['Department Name'] || 'Department'}`;
    } else {
      title = `Schedule for All Lawyers`;
    }
        ...
        <div class="print-container">
          <div class="print-header">
            ...
            <div class="meta-info">
              ...
              <span>Total Lawyers: ${doctorsToPrint.length}</span>
            </div>
          </div>
      ...
      <div className="space-y-6">
        <div>
          ...
          <Select
            ...
            options={[
              { value: 'selected', label: 'Selected Lawyers' },
        ...
        <div className="text-sm text-gray-600">
          {doctorsToPrint.length} lawyer(s) will be included in the printout.
        </div>
