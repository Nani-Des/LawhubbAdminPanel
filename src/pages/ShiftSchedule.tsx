        ...
        <body>
          <div class="print-container">
            <div class="print-header">
              <h1>${hospitalName}</h1>
              <h2>Lawyer Shift Schedule - ${monthName}</h2>
              ...
              <div class="meta-info">
                ...
                <span>Total Lawyers: ${usersToPrint.length}</span>
              </div>
            </div>
      ...
      <div className="space-y-6 p-6 rounded-lg text-gray-100">
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="mt-2 text-base text-gray-900">
              View daily shift schedules for lawyers
            </p>
          </div>
        ...
        {conflicts.length > 0 && (
          <div className="bg-red-600 text-white p-4 rounded-xl no-print">
            Warning: No lawyers available on days {conflicts.join(", ")}
          </div>
        )}
        <div className="sticky top-0 z-10 py-4 flex flex-col sm:flex-row gap-4 no-print">
          <Input
            placeholder="Search by lawyer name or practice..."
        ...
        Printed: {new Date().toLocaleDateString()}
          ...
          <div className="print-content">
            ...
            <table className="print-table">
              <thead>
                <tr>
                  <th className="physician-col">Lawyer</th>
                  {days.map((day) => (
