...
const ReportsPage: React.FC = () => {
  ...
  const exportToCSV = () => {
    ...
    switch (selectedReportType) {
      case 'chamber':
        csvContent = 'Chamber Name,Location,City,Region,Contact,Practices Count\n';
        ...
        break;
      case 'practice':
        csvContent = 'Practice ID,Practice Name\n';
        ...
        <div className="flex justify-between items-start">
          <div>
            ...
            <p className="mt-2 text-base text-gray-700">
              Generate comprehensive reports on chambers, practices, users, and library resources
            </p>
          </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-md border border-gray-100 hover:shadow-lg transition-shadow duration-200">
          ...
          <Select
            ...
            options={[
              ...
              { value: 'practice', label: 'Practice Report' },
        ...
        {selectedReportType === 'summary' && (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="bg-white p-6 rounded-xl shadow-md border border-gray-100 hover:shadow-lg transition-shadow duration-200">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Practices per Chamber (Top 10)</h3>
                <div className="h-64">
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden">
            <div className="p-4 border-b border-gray-200">
              <h3 className="text-lg font-semibold text-gray-900">
                ...
                {selectedReportType === 'practice' && 'Practice Report'}
            ...
            <div className="overflow-x-auto">
                ...
                <Table>
                  <Table.Header>
                    <Table.Row>
                      ...
                      <Table.Head>Practices</Table.Head>
              ...
              {selectedReportType === 'practice' && (
                <Table>
                  <Table.Header>
                    <Table.Row>
                      <Table.Head>Practice ID</Table.Head>
                      <Table.Head>Practice Name</Table.Head>
                    </Table.Row>
                  </Table.Header>
                  <Table.Body>
                ...
                <Table>
                  <Table.Header>
                    <Table.Row>
                      ...
                      <Table.Head>Practice</Table.Head>
                      <Table.Head>Region</Table.Head>
